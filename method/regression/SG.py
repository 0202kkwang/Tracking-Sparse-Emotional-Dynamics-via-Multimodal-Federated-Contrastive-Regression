...
from Regression2.method.model.TEST.ours import concoder
from tqdm import tqdm
from Regression2.dataloader.IG import patch2loader_IG_emo_sequence
...
class Trainer(object):
    ...
    def train(self, epoch, train_loader):
        ...
        for i, sample in enumerate(tbar):
            x_pf, x_f, x_lt, x_c, x_rt, x_lp, x_p, x_rp, x_o, x_eye, target = sample[0], sample[1], sample[2], sample[
                3], \
...
if __name__ == '__main__':
    ...
    for type in category:
        for session in range(1, 4):
            ...
            parser.add_argument("--steps_per_epoch", type=int, default=128, help="the number of batches per epoch")
            ...
            # 载入de loader
            train_loader, test_loader_list, test_int_label_list = patch2loader_IG_emo_sequence(args)
            ...
            for i in range(0, 60):
                ...
                dict_path = r"C:\Users\PS\Desktop\SCI\experiment\Ablation study\SEED\IG\replace fusion-test\\"
